...
class UserProfile(QWidget):
    ...
    def displayUserInfo(self):
            ...
            user_name.setText("Raul Bartolomé Gonzalo")
            ...
            about = QLabel(self)
            about.setText("I'm a QA trying to switch to Automation.")
            ...
            experience.setText("Senior QA Analyst at King")
            ...
            experience = QLabel(self)
            experience.setText("Manual QA Tester at Sopra Steria")
